% original version written by Lea Schuh and Yogesh Goyal, 2020
% Schuh et al., Cell Systems, 2020
...
function uniquetok = make_param_mex_bursts_nitc(inputfile, outputfile, n_species_upstr, n_species_paralog, n_species_downstr, iruns)
