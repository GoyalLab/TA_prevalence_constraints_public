%% Generate data - B-4-state model
% diploid, alleles independent, NITC affects ancestral and paralogs
% substrate competition between ancestral and paralog at target burst-on

% No basal paralog expression
% 1.7.2 samples parameters on the log scale rather than linear
% log10(2) = 0.301, log10(5) = 0.699

% Same parameters for both paralogs, except for Bprod when onAprim1 vs
% onAprim2. A new ratio is added, Aprim1_Aprim2_prodon_ratio, which scales 
% Bprod in the two paralog states. Spans two orders of magnitude, 1:100. A 
% value of 100 means that Aprim1 is 100-times better at causing B transcription.
% 

% EDIT THESE OUTPUT DIRECTORIES AS NEEDED
% trace_outdir = '/Volumes/IAMYG2/grn_nitc_data/v1.7/';
% psc_outdir = '~/OneDrive/projects/grn_nitc/grn_nitc_data/v1.7/';

trace_outdir = '/Volumes/IAMYG2/grn_nitc_data/v1.7.2/fullTraces/';
psc_outdir = '/Volumes/IAMYG2/grn_nitc_data/v1.7.2/samples/';
psc_refdir = '~/code/grn_nitc/nitc_4node_v1.7.2/';
...
%         'n_B1'};
    ...
    Burst1_onpara1_targ_allele1,...
    Burst1_onpara2_targ_allele1,...
    Burst1_off_targ_allele1,...
    Burst1_onorig_targ_allele2,...
    Burst1_onpara1_targ_allele2,...
    Burst1_onpara2_targ_allele2,...
    Burst1_off_targ_allele2,...
    Burst1_on_para1_allele1,...
    Burst1_on_para1_allele2,...
    Burst1_on_para2_allele1,...
    Burst1_on_para2_allele2,...
