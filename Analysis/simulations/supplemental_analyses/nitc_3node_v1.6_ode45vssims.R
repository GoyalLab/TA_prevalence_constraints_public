...
# edit as needed
datadir <- '/Volumes/IAMYG1/grn_nitc_data/v1.6/'
plotdir <- '~/code/grn_nitc/nitc_3node_v1.6_B3state/exploratory_analysis/'
setwd(datadir)
...
#wtwt ode45
setwd(plotdir)
steadystate_ode45_wtwt <- as_tibble(read.csv('../steady_state_ODE45_wtwt_B3state.csv', header = T))
...
steadystate_ode45_wtmut <- as_tibble(read.csv('../steady_state_ODE45_wtmut_B3state.csv', header = T))
...
steadystate_ode45_mutmut <- as_tibble(read.csv('../steady_state_ODE45_mutmut_B3state.csv', header = T))
