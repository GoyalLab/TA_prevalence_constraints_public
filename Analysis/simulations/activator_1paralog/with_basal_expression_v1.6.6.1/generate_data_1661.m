...
% Add baseline expression of paralog per what we see in Datlinger 2017
% dataset.

% EDIT THESE OUTPUT DIRECTORIES AS NEEDED
trace_outdir = '/Volumes/IAMYG1/grn_nitc_data/v1.6.6.1/fullTraces/';
psc_outdir = '/Volumes/IAMYG1/grn_nitc_data/v1.6.6.1/samples/';
psc_refdir = '~/code/grn_nitc/nitc_3node_v1.6.6.1/refs/';
