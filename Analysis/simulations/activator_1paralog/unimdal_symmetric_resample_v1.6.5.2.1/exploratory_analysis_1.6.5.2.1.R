...
paramspace_linear <- lhs_sets52 %>%
  ...
  summarise(minimum = min(value),
            maximum = max(value))
paramspace_log <- paramspace_linear %>%
  mutate(minimum = log10(minimum),
         maximum = log10(maximum))

isbimodal_het_log_paramranges <- parse_partykit(temp.tree, paramspace_log)
write.csv(isbimodal_het_log_paramranges, 
          file = paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isbimodal_het_log_paramranges.csv'), 
          quote = F, row.names = F)
...
pdf(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isLeftSkewedHet_tree_log.pdf'), width = 10, height = 10)
plot(temp.tree)
dev.off()

svglite(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isLeftSkewedHet_tree_log.svg'), width = 10, height = 10)
plot(temp.tree)
dev.off()
...
pdf(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isRightSkewedHet_tree_log.pdf'), width = 30, height = 10)
plot(temp.tree)
dev.off()

svglite(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isRightSkewedHet_tree_log.svg'), width = 30, height = 10)
plot(temp.tree)
dev.off()
...
pdf(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isLowAvgHet_tree_log.pdf'), width = 50, height = 10)
plot(temp.tree)
dev.off()

svglite(paste0(plotdir52, 'stats_class_assignment_check_v', as.character(anver),'/isLowAvgHet_tree_log.svg'), width = 50, height = 10)
plot(temp.tree)
dev.off()
