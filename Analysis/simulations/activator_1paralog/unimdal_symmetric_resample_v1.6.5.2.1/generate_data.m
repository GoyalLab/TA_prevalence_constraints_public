...
% Confirm unimodal symmetric enrichment run for v1.6.5.2 unisymm tree node
% 75 subspace from log tree.
...
trace_outdir = '~/Documents/grn_nitc_data/simulations/v1.6.5.2.1/fullTraces/';
psc_outdir = '~/Documents/grn_nitc_data/simulations/v1.6.5.2.1/samples/';
...
% unisym_table = readtable('~/Documents/grn_nitc_data/simulations/v1.6.5.2.1/resamp_bounds.csv');
%%
rng(8363);
...
min_range = [repmat(0.324,1,1),...         %basal_nitc_on_ratio (0.1,10) - is 10 high enough?
    repmat(-0.473,1,1),...                  %onbasalA1_off_ratio (0.01,2) - per Larsson this is the bulk of the distribution (very quick off-burst)
    repmat(-1,1,1),...                  %A1_Aprime1_addon_ratio (0.1,10)
    repmat(-0.468,1,1),...                  %A1_Aprime_prodon_ratio (0.1,10)
    repmat(0.942,1,1),...                   %r_prod_on (1,1000)
    repmat(-0.15,1,1),...                  %r_addon_byA1_B1 (0.1,10)
...
%%
ranges = max_range - min_range;
ranges_t = array2table(ranges);
ranges_t.Properties.VariableNames = {'basal_nitc_on_ratio',... 
    'onbasalA1_off_ratio',...
    ...
    'r_onbasal_A1'};
%%
writetable(ranges_t, [trace_outdir, 'latinhyp_sampledSets_log10_ranges.csv'],'Delimiter',',')
%%
