...
% this is v1.6.5.1.3 - 10th percentile radii
...
trace_outdir = '~/Documents/grn_nitc_data/simulations/v1.6.5.1.3/fullTraces/';
psc_outdir = '~/Documents/grn_nitc_data/simulations/v1.6.5.1.3/samples/';
...
min_range = [repmat(range_table.min_val_10_log10(1),1,1),...        %basal_nitc_on_ratio (0.1,10) - is 10 high enough?
    repmat(range_table.min_val_10_log10(2),1,1),...                %onbasalA1_off_ratio (0.01,1) - per Larsson this is the bulk of the distribution (very quick off-burst)
    repmat(range_table.min_val_10_log10(3),1,1),...                 %A1_Aprime1_addon_ratio (0.1,10)
    repmat(range_table.min_val_10_log10(4),1,1),...                 %A1_Aprime_prodon_ratio (0.1,10)
    repmat(range_table.min_val_10_log10(5),1,1),...                   %r_prod_on (1,1000)
    repmat(range_table.min_val_10_log10(6),1,1),...                 %r_addon_byA1_B1 (0.1,5)
    repmat(range_table.min_val_10_log10(7),1,1),...                 %n (Hill coefficient n) (0.1,10) too large a range? I think so, but having some non-linearity is good. Perhaps ok with 10000 paramsets.
    repmat(range_table.min_val_10_log10(8),1,1)];                   %r_onbasal_A1 (0.1, 10)
%                                       

max_range = [repmat(range_table.max_val_10_log10(1),1,1),...        %basal_nitc_on_ratio (0.1,10) - is 10 high enough?
    repmat(range_table.max_val_10_log10(2),1,1),...                %onbasalA1_off_ratio (0.01,1) - per Larsson this is the bulk of the distribution (very quick off-burst)
    repmat(range_table.max_val_10_log10(3),1,1),...                 %A1_Aprime1_addon_ratio (0.1,10)
    repmat(range_table.max_val_10_log10(4),1,1),...                 %A1_Aprime_prodon_ratio (0.1,10)
    repmat(range_table.max_val_10_log10(5),1,1),...                   %r_prod_on (1,1000)
    repmat(range_table.max_val_10_log10(6),1,1),...                 %r_addon_byA1_B1 (0.1,5)
    repmat(range_table.max_val_10_log10(7),1,1),...                 %n (Hill coefficient n) (0.1,10) too large a range? I think so, but having some non-linearity is good. Perhaps ok with 10000 paramsets.
    repmat(range_table.max_val_10_log10(8),1,1)];                   %r_onbasal_A1 (0.1, 10)
