...
% basal_nitc_on_ratio <= 1.31595 ; log10(1.31595) = 0.1192
% A1_Aprime1_addon_ratio > 2.07278 ; log10(2.07278) = 0.3166
% A1_Aprime_prodon_ratio > 0.37067 ; log10(0.37067) = -0.4310
...
psc_refdir = '~/code/grn_nitc/nitc_3node_v1.6.5.3/samples/';
...
min_range = [repmat(-1,1,1),...         %basal_nitc_on_ratio (0.1,10) - is 10 high enough?
    ...
    repmat(0.3166,1,1),...                  %A1_Aprime1_addon_ratio original range(0.1,10)
    repmat(-0.4310,1,1),...                  %A1_Aprime_prodon_ratio original range(0.1,10)
...
% 
max_range = [repmat(0.1192,1,1),...          %basal_nitc_on_ratio (0.1,10) original range - is 10 high enough?
